# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_data.datasets.ipynb.

# %% auto 0
__all__ = ['ImageDataset', 'MnistDataset', 'FashionMnistDataset']

# %% ../../nbs/01_data.datasets.ipynb 3
import pandas as pd
import torchvision
